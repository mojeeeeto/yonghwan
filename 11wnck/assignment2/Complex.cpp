...
Number *Complex::add(Number * num) {
	...
	if (num->types() == INTEGER)
	{
		...
		this->set_val(this->val().first + other->val(), this->val().second);
		delete(other);
		return this;
	}
	...
	else if (num->types() == COMPLEX)
	{
		...
		this->set_val(this->val().first + other->val().first, this->val().second + other->val().second);
		delete(other);
		return this;
	}
    return nullptr;
...
Number *Complex::mul(Number * num) {
	...
	{
		Integer* other = dynamic_cast<Integer*>(num);
		this->set_val(this->val().first * other->val(), this->val().second*other->val());
		delete(other);
		return this;
	}
	else if (num->types() == FLOAT)
	...
	{
		Complex* other = dynamic_cast<Complex*>(num);
		this->set_val(this->val().first * other->val().first - this->val().second*other->val().second, this->val().first * other->val().second + this->val().second * other->val().first);
		delete(other);
		return this;
	}
    return nullptr;
