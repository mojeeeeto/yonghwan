...
int main() {
	...
	map<string, int>::iterator it = m.find("first");
	int m1 = (*it).second; // m에서 key값을 넣어 value를 얻어 채우세요
	it = m.find("second");
	int m2 = (*it).second; // m에서 key값을 넣어 value를 얻어 채우세요
	it = m.find("third");
	int m3 = (*it).second; // m에서 key값을 넣어 value를 얻어 채우세요
	it = m.find("fourth");
	int m4 = (*it).second; // m에서 key값을 넣어 value를 얻어 채우세요
